...
func setMovementTiles(currentPosition: Vector2):
	...
	tilemap.set_cell(1,Vector2i(currentPosition.x,currentPosition.y),3,Vector2i(0,0))
	tilemap.set_cell(1,Vector2i(currentPosition.x+1,currentPosition.y),3,Vector2i(0,0))
	tilemap.set_cell(1,Vector2i(currentPosition.x-1,currentPosition.y),3,Vector2i(0,0))
	tilemap.set_cell(1,Vector2i(currentPosition.x,currentPosition.y+1),3,Vector2i(0,0))
	tilemap.set_cell(1,Vector2i(currentPosition.x,currentPosition.y-1),3,Vector2i(0,0))
